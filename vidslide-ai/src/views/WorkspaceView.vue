/** * WorkspaceView.vue - VidSlide AI 工作页面 * 完全复刻桌面UI设计图 */
    ...
    <main class="workspace-main">
      ...
      >
        ...
        <div class="upload-content">
          ...
          <p class="upload-instruction">Drag and drop your video file, or click to browse</p>
      ...
      <!-- 步骤2: AI分析处理 -->
      <div v-if="currentStep === 'processing'" class="processing-area">
          ...
          <div class="processing-status">
            <div class="status-item">
              ...
              <div class="status-progress">
                <div class="progress-bar" :style="{ width: processingProgress.speech + '%' }" />
              </div>
            ...
            <div class="status-item">
              ...
              <div class="status-progress">
                <div class="progress-bar" :style="{ width: processingProgress.content + '%' }" />
              </div>
            ...
            <div class="status-item">
              ...
              <div class="status-progress">
                <div class="progress-bar" :style="{ width: processingProgress.keyframes + '%' }" />
              </div>
            ...
            <div class="status-item">
              ...
              <div class="status-progress">
                <div class="progress-bar" :style="{ width: processingProgress.materials + '%' }" />
              </div>
      ...
      <!-- 步骤3: 编辑工作区 -->
      <div v-if="currentStep === 'editing'" class="editing-area">
        <div class="editor-layout">
          ...
          <section class="main-editor">
            <div class="canvas-container">
              ...
              <!-- 画中画控制 -->
              <div v-if="pipEnabled" class="pip-controls">
                <PictureInPicture
      ...
      try {
        ...
        if (files.length > 0) {
          ...
          if (file.type.startsWith('video/')) {
            ...
            getErrorHandler().handleError(new Error('请拖拽有效的视频文件'), {

...
<template>
    ...
    <main class="panel-content" role="main" aria-labelledby="panel-title">
      ...
      <div class="setting-section">
        ...
        <div class="setting-item">
          ...
          <el-slider
            ...
            @change="onAdjustmentChange"
          />
          <div class="size-display" aria-live="polite">{{ adjustments.size }}%</div>
      ...
      <div class="setting-section">
        ...
        <div class="setting-item">
          ...
          />
          <div id="title-help" class="sr-only">为模板元素设置主要标题文本</div>
        </div>
        ...
        <div class="setting-item">
          ...
          <el-input
            ...
            @input="onAdjustmentChange"
          />
          <div id="subtitle-help" class="sr-only">为模板元素设置辅助标题文本</div>
        </div>
  ...
  <div class="validation-section">
    ...
    <div v-if="validationResult" class="validation-result">
      ...
      <div
        v-if="validationResult.violations && validationResult.violations.length > 0"

...
class ServerCompositionUnitGenerator {
  constructor() {
    this.layoutService = getLayoutService();
    this.cacheDir = path.join(__dirname, '../../../cache/composition-units');
    this.ensureCacheDir();
    ...
    console.log('✅ ServerCompositionUnitGenerator 初始化完成');
  }
...
export function getInstance() {
  if (!instance) {
    instance = new ServerCompositionUnitGenerator();
  }
  return instance;
}

export { ServerCompositionUnitGenerator };
export default ServerCompositionUnitGenerator;

...
if (snapshotData && snapshotData['WorkspaceView.vue'] && snapshotData['WorkspaceView.vue'].backupFile) {
  // 优先使用快照关联的备份文件
  ...
  if (fs.existsSync(backupPath)) {
    ...
    console.log(`  修改时间: ${new Date(snapshotData['WorkspaceView.vue'].lastModified).toLocaleString()}`);

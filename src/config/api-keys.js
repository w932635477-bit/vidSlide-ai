...
// 文心一言 API 配置（ERNIE Bot）
// 申请地址: https://cloud.baidu.com/product/wenxinworkshop
export const WENXIN_CONFIG = {
  apiKey: (typeof process !== 'undefined' && process.env && process.env.WENXIN_API_KEY) || 'ALTAK-rcrLqDcwe4h2DuEqNK5CK',
  secretKey: (typeof process !== 'undefined' && process.env && process.env.WENXIN_SECRET_KEY) || '916a0a8f85d4354539b00ffcfac9c59a18188396',
  model: 'ernie-3.5-8k', // 使用 ERNIE-3.5-8K
